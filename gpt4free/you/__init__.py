...
class Completion:
    ...
    def create(
        ...
        client = Session(client_identifier='chrome_107')
    ...
    def __get_failure_response() -> YouResponse:
        return YouResponse(text='Unable to fetch your response. Please try again.')
    ...
    def __make_request(client: Session, params: dict) -> Response:
        ...
        if 'youChatToken' not in response.text:
            print('Error: Could not get youChatToken for response. Retrying.')
